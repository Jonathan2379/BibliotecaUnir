...
public class Cadastro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSalvar = findViewById(R.id.btn_salvar_atualizar);
        btnVoltar = findViewById(R.id.btn_voltar_atualizar);
        edtTitulo = findViewById(R.id.edt_titulo_atualizar);
        edtAno = findViewById(R.id.edt_ano_atualizar);
        edtAutor = findViewById(R.id.edt_autor_atualizar);
